...
const AddAwsConfigurationForm = () => {
        ...
        fetch('http://localhost:5000/start-powershell', {
            ...
            .then(response => {
                ...
                if (response.ok && response.status === 200) {
                    Swal.fire({
                        title: 'Success!',
                        text: 'PowerShell script started successfully!',
                        icon: 'success',
            ...
            .catch(error => {
                ...
                Swal.fire({
                    title: 'Error!',
                    text: `Error starting PowerShell script: ${error}`,
                    icon: 'error',
    ...
    return ( <
        ...
        onChange = {
            (e) => setInstanceType(e.target.value)
        } > {
        ...
        value = { instanceName }
        onChange = {
            (e) => setInstanceName(e.target.value)
        }
        /> < /
        div > <
        /div> <
        ...
        input type = "text"
        value = { instanceIdDescription }
        onChange = {
            (e) => setInstanceIdDescription(e.target.value)
        }
        /> < /
        div > <
        div className = "form-group" >
        ...
        input type = "text"
        value = { publicIpDescription }
        onChange = {
            (e) => setPublicIpDescription(e.target.value)
        }
        /> < /
        div > <
        /div> <
